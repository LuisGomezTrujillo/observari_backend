...
from app.routers import activity_learner, report_observation, user, auth, profile, users_relationship, activity, observation, report
...
app.include_router(report_observation.router)
